...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { apellidos: @empleado.apellidos, cargo: @empleado.cargo, clave: @empleado.clave, dni: @empleado.dni, nombres: @empleado.nombres, perfil: @empleado.perfil } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { apellidos: @empleado.apellidos, cargo: @empleado.cargo, clave: @empleado.clave, dni: @empleado.dni, nombres: @empleado.nombres, perfil: @empleado.perfil } }
