...
class CitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post cita_url, params: { citum: { apellido: @citum.apellido, codigo: @citum.codigo, dni: @citum.dni, estado: @citum.estado, fecha: @citum.fecha, hora: @citum.hora, nombre: @citum.nombre, telefono: @citum.telefono } }
    end
  ...
  test "should update citum" do
    patch citum_url(@citum), params: { citum: { apellido: @citum.apellido, codigo: @citum.codigo, dni: @citum.dni, estado: @citum.estado, fecha: @citum.fecha, hora: @citum.hora, nombre: @citum.nombre, telefono: @citum.telefono } }
